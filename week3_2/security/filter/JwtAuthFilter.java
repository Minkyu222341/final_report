...
import com.sparta.week3_2.security.jwt.HeaderTokenExtractor;
import com.sparta.week3_2.security.jwt.JwtPreProcessingToken;
...
public class JwtAuthFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException, IOException {
        ...
        System.out.println(Access_Token+"액세스 토큰");
        String Refresh_Token = request.getHeader("Refresh-Token");
        System.out.println(Refresh_Token+"리프레쉬");
        if (Access_Token == null && Refresh_Token == null) {
            response.sendRedirect("/user/loginView");
            return null;
        }
        
        JwtPreProcessingToken jwtToken = new JwtPreProcessingToken(extractor.extract(Access_Token, request));
